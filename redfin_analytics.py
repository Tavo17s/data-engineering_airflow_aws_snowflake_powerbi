...
# s3 buckets
target_bucket_name = 'redfin-bucket-etl'
...
with DAG('redfin_analytics_dag', default_args=default_args, schedule_interval='@weekly', catchup=False) as dag:
    ...
    load_to_s3 = BashOperator(
        ...
        bash_command = 'aws s3 mv {{ ti.xcom_pull("tsk_extract_redfin_data")[0]}} s3://store-raw-data-redfin-etl',
    )
